...
<td metal:define-macro="value" class="column-value column-status">
	<span class="issue-status" tal:attributes="title bug/resolutionLabel" tal:content="bug/statusLabel">Status</span>
    <a tal:define="handler bug/getHandler" tal:condition="php: config.show_assigned_names AND handler"
