...
define( 'ERROR_FILTER_NAME_EMPTY', 2002 );
define( 'ERROR_FILTER_NAME_TOO_LONG', 2003 );
define( 'ERROR_FILTER_NAME_DUPLICATE', 2004 );
define( 'ERROR_FILTER_STORE_ERROR', 2005 );
define( 'ERROR_FILTER_NO_STORED_QUERIES_FOUND_FOR_PROJECT', 2006 );
