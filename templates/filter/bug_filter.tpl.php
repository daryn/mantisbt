		...
		<?php collapse_open( 'filter' ); ?>
			<table cellspacing="1" border="0" width="100%">
				...
				<tr class="row-category2"><?php
					...
					dhtmlLink( $t_relationships_field, $t_for_screen, 2 );
				?></tr>
				<tr class="row-1"><?php
